...
// --- Utility Functions (moved out or kept local as needed) ---
...
const NoExamsFound = ({ searchTerm, filterType }) => (
...
const ExamCard = ({ exam, onToggleStatus, onView, onEdit, onDelete }) => (
  <div className="bg-white rounded-lg shadow-lg border border-neutral-200 hover:shadow-xl transition-shadow duration-200">
    {/* Card Header */}
      ...
      <div className="flex justify-between items-start mb-3">
        ...
        <div className="ml-4 flex items-center gap-2">
          ...
          <Switch
            ...
            onChange={() => onToggleStatus(exam.id)}
          />
        </div>
      </div>
...
// --- Main ExamsCollection Component ---
    ...
    <div className="min-h-screen bg-neutral-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {filteredExams.length === 0 ? (
          <NoExamsFound searchTerm={searchTerm} filterType={filterType} />
        ) : (
